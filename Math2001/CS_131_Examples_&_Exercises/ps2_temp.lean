/- # ps2.lean: 
   # 
   # You can solve the Lean_4 problems for up to 10 extra points
   # in the Lean_4 Playground at https://live.lean-lang.org/ which 
   # will spare you the need to install Lean_4 on your laptop.  
   # 
   ...
   # Gradescope, make sure to de-comment the 'import' on line 20, 
